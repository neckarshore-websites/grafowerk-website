/**
 * Canonical Lighthouse profiles for grafowerk.de.
 *
 ...
 *
 * ── Three profiles (estate standard, German Rauhut directive 2026-06-18) ─────
 ...
 *
 * Network ordering is CORRECT: 5G is faster than 4G.
 *
 * The pre-2026-06-18 "Mobile Slow (Edge-5G)" profile (400 Kbps / 6× CPU) is
 * intentionally absent. 400 Kbps is *slower* than 4G, so the "5G" label inverted
 * reality — a mislabel first flagged 2026-04-10, re-diagnosed in the 2026-06-02
 * site-quality architecture design, and finally corrected across the estate on
 * 2026-06-18. Sub-4G traffic is out of scope: the target audience (Grafowerk's
 * design-studio visitors) is 5G-default, and we do not gate quality on an
 * unserviceable edge-of-coverage scenario.
 *
 ...
 *     are deterministic (a clean static page hits 100) — a drop is a real defect.
 *
 ...
 *
 * Ported from neckarshore-website (estate standard); brought to
 * grafowerk-website 2026-06-24 — the 5th estate site to adopt it.
 */
